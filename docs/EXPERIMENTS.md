...
Training curves for all six runs: `../figures/experiments/wandb1.png` (val/train loss, val/train acc, lr), `../figures/experiments/wandb2.png` (pretrain epochs and LR schedules).
